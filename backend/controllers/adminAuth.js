...
const register = async (req, res) => {
  ...
  const email = req.body?.email || req.query.email || process.env.ADMIN_EMAIL || "admin@gmail.com";
  const password = req.body?.password || req.query.password || process.env.ADMIN_PASSWORD || "admin123";
