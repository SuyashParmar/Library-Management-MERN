...
const Register = () => {
  ...
  return (
    <div className="min-h-screen bg-linear-to-br from-emerald-500 to-teal-600 flex items-center justify-center px-4 py-8">
      <div className="grid md:grid-cols-2 bg-white rounded-2xl shadow-xl overflow-hidden max-w-5xl w-full">
        {/* LEFT HERO */}
        <div className="hidden md:flex flex-col justify-center p-10 bg-emerald-600 text-white">
