        ...
        {loadingRec ? (
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-6 gap-3">
            {recommendations.map((book) => (
              ...
              >
                <div className="h-36 overflow-hidden bg-emerald-50">
                  <img
                    src={
                ...
                <div className="p-2.5 flex flex-col gap-1 flex-1">
                  ...
                  <div className="flex justify-between items-center mt-auto pt-2">
                    ...
                    <button
                      ...
                      className="text-[10px] px-2.5 py-1 bg-emerald-600 hover:bg-emerald-700 text-white rounded-md font-medium transition-colors"
                    >
                      Request
                    </button>
                  </div>
                  ...
                  <div className="flex items-center gap-2.5">
                    ...
                    {b.status === "approved" && (
                      <button
                        ...
                        className="text-xs px-3.5 py-1.5 rounded-lg bg-emerald-600 hover:bg-emerald-700 text-white font-medium transition-colors"
                      >
                        Return
                      </button>
                    )}
