    ...
    <div className="bg-white p-6 rounded-2xl shadow-md border border-gray-100">
      ...
      <div className="flex gap-4 mb-6 flex-wrap items-center">
        <input
          ...
          className="px-4 py-2 border rounded-lg w-full md:w-1/4 focus:ring-2 focus:ring-emerald-500"
        />
          ...
          {filteredBorrows.map((b) => (
            ...
            >
              ...
              >
                ...
                <p className=" text-sm text-gray-500 hover:text-emerald-600">
                  {b.book?.title}
                </p>
              </div>
              ...
              <div className="flex items-center gap-3">
                ...
                {b.status === "pending" && (
                  <button
                    ...
                    className="bg-emerald-600 text-white px-4 py-1.5 rounded-lg text-sm hover:bg-emerald-700 active:scale-95 transition"
                  >
                    Approve
                  </button>
                )}
        ...
        <div className="fixed inset-0 bg-black/50 flex justify-center items-center z-50">
          <div className="bg-white w-[90%] max-w-lg rounded-xl shadow-lg p-6 relative">
            ...
            <div className="text-center mb-4">
              <div className="w-16 h-16 mx-auto rounded-full bg-emerald-500 text-white flex items-center justify-center text-xl font-bold">
