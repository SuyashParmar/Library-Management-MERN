        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            <div
              ...
              className="border-2 border-dashed rounded-lg h-36 flex flex-col items-center justify-center cursor-pointer hover:border-emerald-500 transition overflow-hidden"
            >
              {coverPreview ? (
            ...
            {(form.bookType === "digital" || form.bookType === "both") && (
              <div
                ...
                className="border-2 border-dashed rounded-lg h-36 flex flex-col items-center justify-center cursor-pointer hover:border-emerald-500 transition"
              >
                {bookFile ? (
